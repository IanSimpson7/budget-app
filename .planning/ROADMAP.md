...
- [x] 04-05-PLAN.md — /food + /food/config surfaces: locked floor, status badge, flavor line, gateable join, 3 config tables + C1 6-condition human-verify checkpoint (FOOD-04/05/08/10/11/12/13, UI-02, EDGE-02/03)
- [x] 04-06-PLAN.md — Gap closure (b/c/d): FALLBACK_CEILING_SNACK, classifyMealKind, solvencyFloor decoupling, V8 wire, overlap guard (FOOD-06/07/09, EDGE-02/03)
